...
<main>
    ...
    <!-- About Area End -->
    <!--? contact-form start -->
    <section class="contact-form-area section-bg  pt-115 pb-120 fix" data-background="{{asset('assets/img/gallery/section_bg02.jpg')}}">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="{{asset('assets/img/gallery/blog01.png')}}" alt="">
                            </div>
                        </div>
                        <div class="blog-caption">
                            ...
                            <div class="blog-cap">
                                ...
                                <h3><a href="blog_details.blade.php">Here’s what you should know before.</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="{{asset('assets/img/gallery/blog02.png')}}" alt="">
                            </div>
                        </div>
                        <div class="blog-caption">
                            <div class="blog-date text-center">
                            ...
                            <div class="blog-cap">
                                ...
                                <h3><a href="/blog_details">Here’s what you should know before.</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
